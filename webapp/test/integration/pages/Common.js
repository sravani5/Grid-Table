sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("gtab/ZGridTable/app", ".html");
		...
		return Opa5.extend("gtab.ZGridTable.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["gtab/ZGridTable/localService/mockserver"], function (mockserver) {
